...
public class ButtNameAdapter extends ArrayAdapter<ButtName> {
    ...
    //constructor
    public ButtNameAdapter(Context context, int resource, List<ButtName> names) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.buttnames, null, true);
        TextView textViewName = listViewItem.findViewById(R.id.textViewName);
        ImageView imageViewStatus = listViewItem.findViewById(R.id.imageViewStatus);

        //getting the current name
        ButtName name = names.get(position);
