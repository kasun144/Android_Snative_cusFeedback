...
public class RNameAdapter extends ArrayAdapter<RName> {
    ...
    //constructor
    public RNameAdapter(Context context, int resource, List<RName> names) {
