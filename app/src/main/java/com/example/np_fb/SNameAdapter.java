...
public class SNameAdapter extends ArrayAdapter<SName> {
    ...
    //constructor
    public SNameAdapter(Context context, int resource, List<SName> names) {
